        ...
        <div class="col-md-12">
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    <p>Выполнен вход: <strong><%: User.Identity.GetUserName() %></strong>.
                        <% string role = "";
                            if (User.IsInRole(rolesController.AdminRole))
                                role = "Администратор";
                            else if (User.IsInRole(rolesController.SellerRole))
                                role = "Продавец";
                            else if (User.IsInRole(rolesController.ManagerRole))
                                role = "Директор";%>
                          Тип учетной записи: <strong> <%: role %></strong>.
                    </p>
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmNewPassword"
                                    CssClass="text-danger" Display="Dynamic" ErrorMessage="Поле подтверждения нового пароля заполнять обязательно."
                                    ValidationGroup="ChangePassword" />
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button runat="server" Text="Смена пароля" OnClick="ChangePassword_Click" CssClass="btn btn-default" ValidationGroup="ChangePassword" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" Text="Удалить" CommandName="Delete" CausesValidation="false"
                                    ToolTip='<%# "Удалить это имя входа " + Item.LoginProvider + " из вашей учетной записи" %>'
